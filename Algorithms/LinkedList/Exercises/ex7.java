...
public class ex7 {
	/**
	 * given two linked lists, determine if the two lists intersect and return the intersecting node. 
	 * Note that the intersection is defined based on the reference, not the value. That is, if the 
	 * kth node of the first linked list is the exact same node (by reference) as the jth node of the
	 * second one, then they are intersecting.
	 * 
	 * @author luisa
	 * @param <T>
	 *  
	 ...
	 * implies changing the inner structure in the linked list.
	 * 
	 * @param l1
	 * @param l2
	 * @return intersection
